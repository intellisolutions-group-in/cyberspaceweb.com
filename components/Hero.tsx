    ...
    <section className="relative flex flex-col items-center w-full bg-[#0A0A0A] py-16 px-6 md:py-[100px] md:px-[120px] overflow-hidden">
      ...
      <div className="flex items-center justify-center gap-[8px] h-[32px] px-[12px] md:px-[16px] bg-[#1A1A1A] border-2 border-[#FFD600]">
        ...
        <span className="font-ibm-mono text-[9px] md:text-[11px] font-bold text-[#FFD600] tracking-[1px] md:tracking-[2px] whitespace-nowrap">
          [{company.establishedYear}] // {company.industry.toUpperCase()} {company.country.toUpperCase()}
        </span>
      </div>
      ...
      <p className="font-ibm-mono text-[13px] md:text-[15px] text-[#888888] tracking-[1px] leading-[1.6] text-center w-full max-w-[800px]">
        IT / SOFTWARE DEVELOPMENT FOR INDIAN BUSINESSES THAT NEED CLEAR,
        MAINTAINABLE DIGITAL SYSTEMS.
        <br />
        WEB // MOBILE // DESKTOP // API // DATABASE // CLOUD.
      </p>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-[16px] w-full sm:w-auto">
        ...
        <Link href="/services/" className="flex items-center justify-center w-full sm:w-[200px] h-[56px] bg-[#0A0A0A] border-2 border-[#3D3D3D] hover:border-[#888888] transition-colors">
...
const layers = [
  { label: "PROJECT / PLATFORM", color: "#FFD600", indent: 0, active: true },
  { label: "DISCOVERY", color: "#888", indent: 12 },
  { label: "UI / UX", color: "#4ADE80", indent: 12 },
  { label: "API LAYER", color: "#888", indent: 12 },
  { label: "DATA MODEL", color: "#FF6B35", indent: 12 },
  { label: "WEB APP", color: "#FF6B35", indent: 24 },
  { label: "MOBILE APP", color: "#888", indent: 24 },
  { label: "QA + RELEASE", color: "#60A5FA", indent: 12 },
  { label: "SUPPORT", color: "#888", indent: 0 },
];
...
const tickerItems = [
  "WEB", "MOBILE", "API", "DATABASE", "CLOUD",
  "QA", "SUPPORT", "PWA", "DESKTOP", "CONSULTING",
];
  ...
  return (
    <>
      ...
      >
        ...
        <text x="280" y="84" fontFamily="monospace" fontSize="8" fill="#FFD600" letterSpacing={1}>PROJECT / PLATFORM - 1100 x 580</text>
        ...
        <text x="360" y="293" fontFamily="monospace" fontSize="7" fill="#333" letterSpacing={1}>roadmap.ts - cyberspaceweb</text>
